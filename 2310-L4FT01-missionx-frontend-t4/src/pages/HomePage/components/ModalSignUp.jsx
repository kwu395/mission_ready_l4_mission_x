...
// Handle signup form submission logic here
  ...
  const handleStudentSignupSubmit = (event) => {
    ...
    if (passwordSignUp !== confirmPasswordSignUp) {
      // const messageNotMatchStudent = <span>Passwords do not match</span>
      ...
      .then((res) => {
        if (res.status === 200) {
          console.log('success')
          const messageSuccessTeacher = <span>Sign up successful</span>
          setMsgToRenderStudentSignup(messageSuccessTeacher)
